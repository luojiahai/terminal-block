...
describe('formatTokens', () => {
  ...
  it('formats 9999 as 9.9k (no rounding up)', () => expect(formatTokens(9999)).toBe('9.9k tokens'))
  ...
  it('formats 9999999 as 9.9m (no rounding up)', () => expect(formatTokens(9999999)).toBe('9.9m tokens'))
